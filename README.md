...
uv run python scripts/analyze_gate2_sign_resolution.py      # resolves an apparent Gate-2-vs-bin-plot sign contradiction (see AMENDMENTS.md item 6); needs the frozen composite and experiment3_human_scores.csv
```
